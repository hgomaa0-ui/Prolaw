...
const ROLE_PAGES: Record<string,string[]> = {
  OWNER:["clients","projects","time","expenses","invoices","reports","accounts","settings","hr","hr_report","leaves","notifications"],
  MANAGING_PARTNER:["clients","projects","time","expenses","invoices","reports","accounts","settings","hr","leaves","notifications"],
  ADMIN:["clients","projects","time","expenses","invoices","reports","accounts","settings","hr","hr_report","leaves","notifications"],
  ...
  HR_MANAGER:["hr","hr_report","employees","payroll","leaves","positions","notifications"],
  LAWYER_MANAGER:["time","expenses","reports","leaves","notifications","settings"],
  HR:["hr","hr_report","payroll","leaves","notifications"],
...
const links:NavLink[] = [
  ...
  { href: "/admin/hr/report", label: "HR Report", key:"hr_report" },
