...
import TasksTable from "@/components/TasksTable";          // جدول التـاسكات
...
export default function ProjectDetailPage() {
  ...
  const [attType, setAttType] =
    useState<"POWER_OF_ATTORNEY" | "CONTRACT" | "OTHER">("OTHER");
  ...
  const fetchPayments = async () => {
    try {
      const res = await fetch(
        `/api/advance-payments?projectId=${projectId}`,
