...
// TODO: Replace localStorage with PocketBase CRUD when pb client path is confirmed
...
const SaveButton = () => {
  ...
  const handleSave = () => {
    ...
    alert("Saved layout to localStorage (replace with PocketBase save)");
  };
  return (
    <button
      onClick={handleSave}
    ...
    <div className="flex h-screen">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-auto">
          <Editor
            resolver={{ TextBlock, ImageBlock, ContainerBlock }}
            enabled={true}
          >
